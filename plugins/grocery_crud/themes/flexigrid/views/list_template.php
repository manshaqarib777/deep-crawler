	...
	<div class="tDiv">
		...
		<div class="tDiv2">
        	<a href='<?php echo $add_url?>' title='<?php echo $this->l('list_add'); ?> <?php echo $subject?>' class='btn btn-warning'>							
				<i class='fa fa-plus-circle'></i>	<?php echo "Add";?>	
            </a>			
		</div>
		<?php }?>
		<div class="tDiv3">
	...
	<div class="sDiv quickSearchBox" id='quickSearchBox' style="display:block;background:#fff;border-bottom:none">
		<div class="sDiv2">
			<div class="form-group">
				<input type="text" style='width:150px' placeholder="Search" class="qsbsearch_fieldox search_text form-control" name="search_text" size="30" id='search_text'>
			</div>
			<div class="form-group">
